...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    /// <summary>
    /// HoloLens webCamTexture async detect face overlay example.
    ...
    public class HoloLensWebCamTextureAsyncDetectFaceOverlayExample : MonoBehaviour
    {
        /// <summary>
        /// The gray mat.
        /// </summary>
...
//            #if UNITY_WSA
//            #if NETFX_CORE
//            Debug.Log("UNITY_WSA NETFX_CORE");
//            #else
//            Debug.Log("UNITY_WSA !NETFX_CORE");
//            #endif
//            #else
...
//                }
                ...
                if(isShowingDebugFaceRects)
                {
                    rectsCount = resultObjects.Count + 2;
                }else{
                    rectsCount = resultObjects.Count;
                }
                ...
                if(isShowingDebugFaceRects)
                {
                    overlayRects[rectsCount-2] = new UnityEngine.Rect(0, 0, 1, 1);
                    overlayRects[rectsCount-1] = new UnityEngine.Rect(offsetX, offsetY
                        , processingAreaRect.width / width, processingAreaRect.height / height);
                }
