...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    public class HoloLensArUcoWebCamTextureExample : MonoBehaviour
    {
        ...
        UnityEngine.Object syncDetect = new UnityEngine.Object ();
        ...
        public void OnWebCamTextureToMatHelperInited ()
        {
            ...
            // Change webcamtexture fps.
            webCamTextureToMatHelper.GetWebCamTexture().requestedFPS = 15f;
        ...
        {
            lock (syncDetect) {
                if (estimatePose && ARTransMatrixUpdated) {
